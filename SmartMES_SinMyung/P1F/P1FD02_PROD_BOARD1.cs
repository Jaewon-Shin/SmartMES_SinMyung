...
{
    public partial class P1FD02_PROD_BOARD1 : SmartMES_SinMyung.FormBasic
    {
        MySqlConnection con;

        public P1FD02_PROD_BOARD1()
        {
            InitializeComponent();
        }
        private void P1FD02_PROD_BOARD1_Load(object sender, EventArgs e)
        {
            facilityInit();
            facilityUpdate();
            graphUpdate();
            ...
            for (int i = 1; i <= 25; i++)
            {
                ...
                try
                {
                    ...
                    if (myData.Read())
                    {
                        ...
                        {
                            pb.Image = Properties.Resources.button전원;
                            pb.Tag = "전원";
                        }
                    }
