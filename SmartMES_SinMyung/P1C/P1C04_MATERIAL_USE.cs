...
{
    public partial class P1C04_MATERIAL_USE : SmartMES_SinMyung.FormBasic
    {
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_SinMyung.Reports.P1C04_MATERIAL_USE.rdlc";
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                iSum += long.Parse(dataGridView1.Rows[i].Cells[6].Value.ToString());
            }

            dataGridView1[3, rowIndex].Value = rowIndex.ToString() + "건";
            dataGridView1[6, rowIndex].Value = iSum;
        }
