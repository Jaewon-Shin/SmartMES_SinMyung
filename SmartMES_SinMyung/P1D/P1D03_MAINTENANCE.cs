...
{
    public partial class P1D03_MAINTENANCE : SmartMES_SinMyung.FormBasic
    {
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            dataGridView1[6, rowIndex].Value = rowIndex.ToString() + "건";
        ...
        {
            string reportFileName = "SmartMES_SinMyung.Reports.P1D03_MAINTENANCE.rdlc";

            string reportParm1 = "점검기간 : ";
            string reportParm2 = "호기/설비명/설비그룹 :";
            string reportParm3 = "";
