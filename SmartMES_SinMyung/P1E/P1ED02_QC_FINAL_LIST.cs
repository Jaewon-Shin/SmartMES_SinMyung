...
{
    public partial class P1ED02_QC_FINAL_LIST : SmartMES_SinMyung.FormBasic
    {
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_SinMyung.Reports.P1ED02_QC_FINAL_LIST.rdlc";

            string reportParm1 = "검사기간 : ";
            string reportParm2 = "거래처명/프로젝트명 : ";
            string reportParm3 = "";
