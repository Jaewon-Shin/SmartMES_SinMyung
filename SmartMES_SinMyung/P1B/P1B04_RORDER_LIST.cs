...
{
    public partial class P1B04_RORDER_LIST : SmartMES_SinMyung.FormBasic
    {
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < rowIndex; i++)
                {
                    ...
                    iSum4 += long.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString());
                    iSum5 += long.Parse(dataGridView1.Rows[i].Cells[11].Value.ToString());
                }

                dataGridView1[7, rowIndex].Value = iSum1;
                dataGridView1[8, rowIndex].Value = iSum2;
                dataGridView1[9, rowIndex].Value = iSum3;
                dataGridView1[10, rowIndex].Value = iSum4;
                dataGridView1[11, rowIndex].Value = iSum5;
            }
            catch (NullReferenceException)
            {
                return;
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_SinMyung.Reports.P1B04_RORDER_LIST.rdlc";
