...
{
    public partial class P1B13_STOCK_TABLE : SmartMES_SinMyung.FormBasic
    {
        ...
        public void ListSearch()
        {
            try
            {
                ...
                sP_StockTable_QueryTableAdapter.Fill(dataSetP1B.SP_StockTable_Query, dtFromDate, dtToDate, sKind, sDepot);
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_SinMyung.Reports.P1B13_STOCK_TABLE.rdlc";
