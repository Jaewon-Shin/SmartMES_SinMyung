...
{
    public partial class P1B10_PURCHASE_MAT : SmartMES_SinMyung.FormBasic
    {
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < rowIndex; i++)
                {
                    ...
                    iSum3 += long.Parse(dataGridView1.Rows[i].Cells[17].Value.ToString());
                    iSum4 += long.Parse(dataGridView1.Rows[i].Cells[18].Value.ToString());
                    iSum5 += long.Parse(dataGridView1.Rows[i].Cells[19].Value.ToString());
                    iSum6 += long.Parse(dataGridView1.Rows[i].Cells[20].Value.ToString());

                    //dataGridView1.Rows[i].DefaultCellStyle.BackColor = Color.FromArgb(93, 123, 157);
                    if (dataGridView1[25, i].Value.ToString() == "1")
                        dataGridView1.Rows[i].DefaultCellStyle.BackColor = Color.Yellow;
                    else
                        dataGridView1.Rows[i].DefaultCellStyle.BackColor = Color.White;

                    if (!(dataGridView1.Rows[i].Cells[23].Value == null ||
                        string.IsNullOrEmpty(dataGridView1.Rows[i].Cells[23].Value.ToString())))
                    {
                        buttonCell = (DataGridViewButtonCell)dataGridView1.Rows[i].Cells[14];
                ...
                dataGridView1[17, rowIndex].Value = iSum3;
                dataGridView1[18, rowIndex].Value = iSum4;
                dataGridView1[19, rowIndex].Value = iSum5;
                dataGridView1[20, rowIndex].Value = iSum6;
            }
            catch (NullReferenceException)
            {
                return;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == 14)
            {
                ...
                if (dataGridView1.Rows[e.RowIndex].Cells[15].Value.ToString() == "0")
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (!(e.ColumnIndex == 17 || e.ColumnIndex == 18 || e.ColumnIndex == 19 || e.ColumnIndex == 20))
                return;
            ...
            else
            {
                if (e.ColumnIndex == 18)
                {
                    long lQty = long.Parse(dataGridView1.Rows[e.RowIndex].Cells[17].Value.ToString());
                    long lDanga = long.Parse(dataGridView1.Rows[e.RowIndex].Cells[9].Value.ToString());
                    long lAmount = long.Parse(dataGridView1.Rows[e.RowIndex].Cells[18].Value.ToString());
        ...
        {
            string reportFileName = "SmartMES_SinMyung.Reports.P1B10_PURCHASE_MAT.rdlc";
