...
{
    public partial class P1B09_DELI_NON : SmartMES_SinMyung.FormBasic
    {
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < rowIndex; i++)
                {
                    ...
                    iSum6 += long.Parse(dataGridView1.Rows[i].Cells[13].Value.ToString());
                }
                ...
                dataGridView1[13, rowIndex].Value = iSum6;
            }
            catch (NullReferenceException)
            {
                return;
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_SinMyung.Reports.P1B09_DELI_NON.rdlc";
